...
export default defineConfig(({ mode }) => {
  ...
  return {
    // Scheme B: embed as a sub-site under the personal brand site at /practice/.
    // Figma preview builds still pass FIGMA_PUBLIC_URL, so they are unaffected.
    base: process.env.FIGMA_PUBLIC_URL ? `${process.env.FIGMA_PUBLIC_URL}/` : '/practice/',
    build: {
