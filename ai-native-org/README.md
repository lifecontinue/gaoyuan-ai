...
本目录沉淀团队从「工具堆叠」进化为 **AI Native 组织** 的完整基建：架构、**组织节奏**、工作流、Skill/MCP/Plugin、可复制工具清单。
...
**一句话**：人的节奏定义何时对齐与决策；工具与 Agent 负责把上下文运到现场、把结论送回 Linear/Docs。Auth0 + Gateway 管身份密钥；Rippling / Salesforce / PandaDoc 接住 People 与 Sales；Slack 反馈经 Bot 评估入库；LangGraph/n8n 编排；Langfuse/Datadog/Audit 保证可追责。
